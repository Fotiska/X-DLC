    ...
    var e = {
            7403: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.KeyboardHandler = void 0, t.KeyboardHandler = class {
                    constructor(e, t) {
                        this.keyDown = e => {
            ...
            8463: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.MouseHandler = void 0, t.MouseHandler = class {
                    constructor(e, t, s, i) {
                        this.mouseMove = e => {
                        ...
                        e.chunks.forEach((e => function(e) {
                            for (let t = 0; t < i.CHUNK_SIZE; t++)
                                for (let s = 0; s < i.CHUNK_SIZE; s++) {
                                    ...
                                    if (1 === i.type) i.signalsCount > 0 ? i.signal = 1 : i.signal = 0;
                                    else if (2 === i.type) i.signal = 1;
                                    else if (3 === i.type) i.signalsCount > 0 ? i.signal = 1 : i.signal = 0;
                                    else if (4 === i.type) 2 === i.signal ? i.signal = 1 : 0 === i.signal && i.signalsCount > 0 ? i.signal = 2 : 1 === i.signal && i.signalsCount > 0 ? i.signal = 1 : i.signal = 0;
                                    else if (5 === i.type) {
                                        const n = o(e, t, s, i.rotation, i.flipped, 1);
                                        void 0 !== n && 0 !== n.lastSignal ? i.signal = 1 : i.signal = 0
                                    } else if (6 === i.type) i.signalsCount > 0 ? i.signal = 1 : i.signal = 0;
                                    else if (7 === i.type) i.signalsCount > 0 ? i.signal = 1 : i.signal = 0;
                                    else if (8 === i.type) i.signalsCount > 0 ? i.signal = 1 : i.signal = 0;
                                    else if (9 === i.type) 0 === i.signal ? i.signal = 1 : 1 === i.signal && (i.signal = 2);
                                    else if (10 === i.type) i.signalsCount > 0 ? i.signal = 2 : i.signal = 0;
                                    else if (11 === i.type) i.signalsCount > 0 ? i.signal = 2 : i.signal = 0;
                                    else if (12 === i.type) i.signalsCount > 0 ? i.signal = 2 : i.signal = 0;
                                    else if (13 === i.type) i.signalsCount > 0 ? i.signal = 2 : i.signal = 0;
                                    else if (14 === i.type) i.signalsCount > 0 ? i.signal = 2 : i.signal = 0;
                                    else if (15 === i.type) i.signalsCount > 0 ? i.signal = 0 : i.signal = 3;
                                    else if (16 === i.type) i.signalsCount > 1 ? i.signal = 3 : i.signal = 0;
                                    else if (17 === i.type) i.signalsCount % 2 == 1 ? i.signal = 3 : i.signal = 0;
                                    else if (18 === i.type) i.signalsCount > 1 ? i.signal = 3 : 1 === i.signalsCount && (i.signal = 0);
                                    else if (19 === i.type) i.signalsCount > 0 && (0 === i.signal ? i.signal = 3 : i.signal = 0);
                                    else if (20 === i.type) i.signalsCount > 0 && Math.random() < .5 ? i.signal = 5 : i.signal = 0;
                                    else if (21 === i.type) i.signal = 0;
                                    else if (22 === i.type) {
                ...
                t.Chunk = class {
                    constructor(e, t) {
                        ...
                        for (let e = 0; e < n.CHUNK_SIZE; e++)
                            for (let t = 0; t < n.CHUNK_SIZE; t++) this.arrows[e + t * n.CHUNK_SIZE] = new i.Arrow;
                    ...
                    isEmpty() {
                        for (let e = 0; e < n.CHUNK_SIZE; e++)
                            for (let t = 0; t < n.CHUNK_SIZE; t++)
                                if (0 !== this.arrows[e + t * n.CHUNK_SIZE].type) return !1;
                        return !0
                    }
                    getArrowTypes() {
                        const e = new Set;
                    ...
                    clear() {
                        for (let e = 0; e < n.CHUNK_SIZE; e++)
                            for (let t = 0; t < n.CHUNK_SIZE; t++) this.arrows[e + t * n.CHUNK_SIZE].type = 0;
            ...
            3278: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.CHUNK_SIZE = t.CELL_SIZE = void 0, t.CELL_SIZE = 256, t.CHUNK_SIZE = 16
            },
            4817: (e, t, s) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
            ...
            7514: (e, t, s) => {
                ...
                t.LevelArrow = class {
                    constructor(e, t, s, n) {
                        this.type = e, this.x = t, this.y = s, this.action = n, this.levelAction = () => {}, this.state = null, this.isStateValid = !1, this.arrow = new i.Arrow
                    }
                    setAction(e) {
                        this.action = e
                    }
                    ...
                    updateMouseSelection(e, t, s, i) {
                        ...
                        if (this.clearCurrentSelection(), Math.abs(n - a) > .25 || Math.abs(o - r) > .25) {
                            const t = Math.min(l, c),
                                ...
                                n = Math.max(h, d);
                            for (let o = t; o <= i; o++)
                                for (let t = s; t <= n; t++) 0 !== e.getArrowType(o, t) && this.select(o, t)
                        }
                    }
            ...
            2413: (e, t, s) => {
                ...
                ! function(e) {
                    const t = new Map([
                            [0, new i.I18nText("Empty cell", "Пустая клетка", "Порожня клітина", "Пустая клетка", "Case vide")],
                            [1, new i.I18nText("Arrow", "Стрелка", "Стрілка", "Стрэлка", "Flèche")],
                            [2, new i.I18nText("Source block", "Блок источника", "Блок джерела", "Блок крыніцы", "Bloc de source")],
                            [3, new i.I18nText("Blocker", "Блокер", "Блокер", "Блокер", "Bloqueur")],
                            [4, new i.I18nText("Delay arrow", "Стрелка задержки", "Стрілка затримки", "Стрэлка затрымкі", "Flèche de retard")],
                            [5, new i.I18nText("Signal detector", "Детектор сигнала", "Детектор сигналу", "Дэтэктар сігналу", "Directuer du signal")],
                            [6, new i.I18nText("Splitter", "Разветвитель", "Розгалужувач", "Разгалінавальнік", "Diviseur")],
                            [7, new i.I18nText("Splitter", "Разветвитель", "Розгалужувач", "Разгалінавальнік", "Diviseur")],
                            [8, new i.I18nText("Splitter", "Разветвитель", "Розгалужувач", "Разгалінавальнік", "Diviseur")],
                            [9, new i.I18nText("Pulse generator", "Генератор импульса", "Генератор імпульсу", "Генератар імпульсу", "Générateur de pulsion")],
                            [10, new i.I18nText("Blue arrow", "Синяя стрелка", "Синя стрілка", "Сіняя стрэлка", "Flèche bleue")],
                            [11, new i.I18nText("Diagonal arrow", "Диагональная стрелка", "Діагональна стрілка", "Дыяганальная стрэлка", "Flèche diagonale")],
                            [12, new i.I18nText("Blue splitter", "Синий разветвитель", "Синій розгалужувач", "Сіні разгалінавальнік", "Diviseur bleu")],
                            [13, new i.I18nText("Blue splitter", "Синий разветвитель", "Синій розгалужувач", "Сіні разгалінавальнік", "Diviseur bleu")],
                            [14, new i.I18nText("Blue splitter", "Синий разветвитель", "Синій розгалужувач", "Сіні разгалінавальнік", "Diviseur bleu")],
                            [15, new i.I18nText("Not gate", "Отрицание", "Заперечення", "Адмоўнік", "Porte logique de négation")],
                            [16, new i.I18nText("And gate", "И", "І", "І", 'Porte logique "et"')],
                            [17, new i.I18nText("XOR gate", "Исключающее ИЛИ", "Виняткове АБО", "Выключнае АБО", 'Porte logique de négation "XOR"')],
                            [18, new i.I18nText("Latch", "Триггер", "Тригер", "Трыгер", "Déclencheur")],
                            [19, new i.I18nText("T flip-flop", "T-триггер", "T-тригер", "T-трыгер", "Déclencheur-T")],
                            [20, new i.I18nText("Randomizer", "Рандомайзер", "Рандомайзер", "Рандамайзер", "Randomiseur")],
                            [21, new i.I18nText("Button", "Кнопка", "Кнопка", "Кнопка", "Bouton")],
                            [22, new i.I18nText("Source", "Источник", "Джерело", "Крыніца", "Source")],
                            [23, new i.I18nText("Target", "Приемник", "Приймач", "Прыёмнік", "Cible")],
                            [24, new i.I18nText("Directional button", "Направленная кнопка", "Направлена кнопка", "Накіраваная кнопка", "Bouton dirrectionel")]
                        ]),
                        s = new Map([
                            [0, new i.I18nText("Never.", "Никогда.", "Ніколи.", "Ніколі.", "Jamais")],
                            [1, new i.I18nText("On any incoming signal.", "Любым входящим сигналом.", "Будь-яким вхідним сигналом.", "Любым уваходным сігналам.", "Avec n'importe quel signal intrant")],
                            [2, new i.I18nText("Every time.", "Всегда.", "Завжди.", "Заўсёды.", "Toujours")],
                            [3, new i.I18nText("On any incoming signal.", "Любым входящим сигналом.", "Будь-яким вхідним сигналом.", "Любым уваходным сігналам.", "Avec n'importe quel signal intrant")],
                            [4, new i.I18nText("#b(Blue) on any incoming signal if not active.<br>#r(Red) if the current color is #b(blue).", "#b(Синим) при любом входящем сигнале если не активна.<br>#r(Красным) если активна #b(синим).", "#b(Синім) при будь-якому вхідному сигналі якщо не активна.<br>#r(Червоним) якщо активна #b(синім).", "#b(Сіняй) пры любым уваходным сігнале калі не актыўна.<br>#r(Чырвонай) калі актыўна #b(сіняй).", "#b(Bleu) non-actif n'importe le signal intrant.<br>#r(Rouge) si la couleur actuelle est : #b(bleu).")],
                            [5, new i.I18nText("If an cell behind is active.", "Если активна стрелка сзади.", "Якщо активна стрілка ззаду.", "Калі актыўна стрэлка ззаду.", "Si la case derrière est active")],
                            [6, new i.I18nText("On any incoming signal.", "Любым входящим сигналом.", "Будь-яким вхідним сигналом.", "Любым уваходным сігналам.", "N'importe le signal intrant")],
                            [7, new i.I18nText("On any incoming signal.", "Любым входящим сигналом.", "Будь-яким вхідним сигналом.", "Любым уваходным сігналам.", "N'importe le signal intrant")],
                            [8, new i.I18nText("On any incoming signal.", "Любым входящим сигналом.", "Будь-яким вхідним сигналом.", "Любым уваходным сігналам.", "N'importe le signal intrant")],
                            [9, new i.I18nText("#r(Red) if not active.<br>#b(Blue) if the current color is #r(red) or #b(blue).", "#r(Красным) если не активна.<br>#b(Синим) если активна #r(красным) или #b(синим).", "#r(Червоним) якщо не активна.<br>#b(Синім) якщо активна #r(червоним) або #b(синім).", "#r(Чырвонай) калі не актыўна.<br>#b(Сіняй) калі актыўна #r(чырвонай) або #b(сіняй).", "#r(Rouge) quand n'est pas actif.<br>#b(Bleu) quand est actif #r(rouge) ou #b(bleu).")],
                            [10, new i.I18nText("On any incoming signal.", "Любым входящим сигналом.", "Будь-яким вхідним сигналом.", "Любым уваходным сігналам.", "N'importe le signal intrant")],
                            [11, new i.I18nText("On any incoming signal.", "Любым входящим сигналом.", "Будь-яким вхідним сигналом.", "Любым уваходным сігналам.", "N'importe le signal intrant")],
                            [12, new i.I18nText("On any incoming signal.", "Любым входящим сигналом.", "Будь-яким вхідним сигналом.", "Любым уваходным сігналам.", "N'importe le signal intrant")],
                            [13, new i.I18nText("On any incoming signal.", "Любым входящим сигналом.", "Будь-яким вхідним сигналом.", "Любым уваходным сігналам.", "N'importe le signal intrant")],
                            [14, new i.I18nText("On any incoming signal.", "Любым входящим сигналом.", "Будь-яким вхідним сигналом.", "Любым уваходным сігналам.", "N'importe le signal intrant")],
                            [15, new i.I18nText("When there are no incoming signals.", "Когда нет входящих сигналов.", "Коли немає вхідних сигналів.", "Калі няма ўваходных сігналаў.", "Quand il n'y a pas de signaux intrants")],
                            [16, new i.I18nText("On at least two incoming signals.", "При минимум двух входящих сигналах.", "При мінімум двох вхідних сигналах.", "Пры мінімум двух уваходных сігналах.", "Au minimum de deux signaux intrants")],
                            [17, new i.I18nText("On odd number of incoming signals.", "При нечетном количестве входящих сигналов.", "При непарній кількості вхідних сигналів.", "Пры няцотнай колькасці ўваходных сігналаў.", "Quand il y a un nombre de signaux intrants non-paire")],
                            ...
                            [19, new i.I18nText("On any incoming signal if not active. Or when there are no incoming signals and already active.", "При любом входящем сигнале, если не активна. Или когда нет входящих сигналов и уже активна.", "При будь-якому вхідному сигналі, якщо не активна. Або коли немає вхідних сигналів і вже активна.", "Пры любым уваходным сігнале, калі не актыўна. Або калі няма ўваходных сігналаў і ўжо актыўна.", "N'importe le signal intrant, quand n'est pas actif. Ou quand il n'y a pas de signaux intrants et est déjà activé")],
                            [20, new i.I18nText("On any incoming signal with 50% chance.", "При любом входящем сигнале с 50% вероятностью.", "При будь-якому вхідному сигналі з 50% ймовірністю.", "Пры любым уваходным сігнале з 50% верагоднасцю.", "N'importe le signal intrant avec une chance de 50%")],
                            [21, new i.I18nText("When pressed with the left mouse button.", "При нажатии левой кнопкой мыши.", "При натисканні лівою кнопкою миші.", "Пры націсканні левай кнопкай мышы.", "Quand le bouton gauche de la souris est appuyé.")],
                            [22, new i.I18nText("On any incoming signal.", "Любым входящим сигналом.", "Будь-яким вхідним сигналом.", "Любым уваходным сігналам.", "N'importe le signal intrant")],
                            [23, new i.I18nText("On any incoming signal.", "Любым входящим сигналом.", "Будь-яким вхідним сигналом.", "Любым уваходным сігналам.", "N'importe le signal intrant")],
                            [24, new i.I18nText("When pressed with the left mouse button or on any incoming signal.", "При нажатии левой кнопкой мыши или любым входящим сигналом.", "При натисканні лівою кнопкою миші або будь-яким вхідним сигналом.", "Пры націсканні левай кнопкай мышы або любым уваходным сігналам.", "N'importe le signal intrant ou quand le bouton gauche de la souris est appuyé.")]
                        ]),
                        n = new Map([
                            [0, new i.I18nText("Does nothing.", "Ничего не делает.", "Нічого не робить.", "Нічога не робіць.", "Ne fait rien")],
                            [1, new i.I18nText("Sends a signal forwards.", "Передает сигнал вперед.", "Передає сигнал вперед.", "Перадае сігнал наперад.", "Transmet un signal en avant.")],
                            [2, new i.I18nText("Sends signals in four directions around it.", "Передает сигналы в четырех направлениях вокруг себя.", "Передає сигнали в чотирьох напрямках навколо себе.", "Перадае сігналы ў чатырох напрамках навакол сябе.", "Transmet des signaux dans les quatre directions autour de soi-même.")],
                            [3, new i.I18nText("Turns off an arrow in front of it.", "Выключает стрелку перед собой.", "Вимикає стрілку перед собою.", "Выключае стрэлку перад сабою.", "Éteint une flèche devant lui")],
                            [4, new i.I18nText("If the signal is #r(red) sends a signal forwards.", "Если сигнал #r(красный), передает сигнал вперед.", "Якщо сигнал #r(червоний), передає сигнал вперед.", "Калі сігнал #r(чырвоны), перадае сігнал наперад.", "Si le signal est #r(rouge), transmet un signal en avant.")],
                            [5, new i.I18nText("Sends a signal forwards.", "Передает сигнал вперед.", "Передає сигнал вперед.", "Перадае сігнал наперад.", "Transmet un signal en avant")],
                            [6, new i.I18nText("Sends a signal both forwards and backwards.", "Передает сигнал и вперед, и назад.", "Передає сигнал і вперед, і назад.", "Перадае сігнал і наперад, і назад.", "Transmet un signal en avant et en arrière")],
                            [7, new i.I18nText("Sends a signal forward and to the right.", "Передает сигнал вперед и вправо.", "Передає сигнал вперед і праворуч.", "Перадае сігнал наперад і ўправа.", "Transmet un signal en avant et à gauche")],
                            [8, new i.I18nText("Sends a signal forward, right, and left.", "Передает сигнал вперед, вправо и влево.", "Передає сигнал вперед, праворуч і ліворуч.", "Перадае сігнал наперад, управа і ўлева.", "Transmet un signal en avant, à gauche et à droite.")],
                            [9, new i.I18nText("If the signal is #r(red) sends signals in four directions around it.", "Если сигнал #r(красный), передает сигналы в четырех направлениях вокруг себя.", "Якщо сигнал #r(червоний), передає сигнали в чотирьох напрямках навколо себе.", "Калі сігнал #r(чырвоны), перадае сігналы ў чатырох напрамках вакол сябе.", "Si le signal est #r(rouge), transmet des signaux dans les quatre directions autour de soi-même.")],
                            [10, new i.I18nText("Sends a signal forwards, skipping one cell.", "Передает сигнал вперед через одну клетку.", "Передає сигнал вперед через одну клітинку.", "Перадае сігнал наперад праз адну клетку.", "Transmet un signal en avant, en sautant une case.")],
                            [11, new i.I18nText("Sends a signal diagonally.", "Передает сигнал по диагонали.", "Передає сигнал по діагоналі.", "Перадае сігнал па дыяганалі.", "Tranmet un signal en diagonale.")],
                            [12, new i.I18nText("Sends a signal to the two cells directly in front of it.", "Передает сигнал в две клетки перед собой.", "Передає сигнал у дві клітинки перед собою.", "Перадае сігнал у два клеткі перад сабою.", "Transmet un signal dans les deux cases directement devant lui.")],
                            [13, new i.I18nText("Sends a signal forwards, skipping one cell and to the right.", "Передает сигнал вперед через одну клетку и вправо.", "Передає сигнал вперед через одну клітинку і праворуч.", "Перадае сігнал наперад праз адну клетку і ўправа.", "Transmet un signal en avant et à droite, en sautant une case.")],
                            [14, new i.I18nText("Sends a signal forwards and diagonally.", "Передает сигнал вперед и по диагонали.", "Передає сигнал вперед і по діагоналі.", "Перадае сігнал наперад і па дыяганалі.", "Transmet un signal en avant et en diagonale.")],
                            [15, new i.I18nText("Sends a signal forwards.", "Передает сигнал вперед.", "Передає сигнал вперед.", "Перадае сігнал наперад.", "Transmet un signal en avant.")],
                            [16, new i.I18nText("Sends a signal forwards.", "Передает сигнал вперед.", "Передає сигнал вперед.", "Перадае сігнал наперад.", "Transmet un signal en avant.")],
                            [17, new i.I18nText("Sends a signal forwards.", "Передает сигнал вперед.", "Передає сигнал вперед.", "Перадае сігнал наперад.", "Transmet un signal en avant.")],
                            [18, new i.I18nText("Sends a signal forwards.", "Передает сигнал вперед.", "Передає сигнал вперед.", "Перадае сігнал наперад.", "Transmet un ssignal en avant.")],
                            [19, new i.I18nText("Sends a signal forwards.", "Передает сигнал вперед.", "Передає сигнал вперед.", "Перадае сігнал наперад.", "Transmet un ssignal en avant.")],
                            [20, new i.I18nText("Sends a signal forwards.", "Передает сигнал вперед.", "Передає сигнал вперед.", "Перадае сігнал наперад.", "Transmet un ssignal en avant.")],
                            [21, new i.I18nText("Sends signals in four directions around it.", "Передает сигналы в четырех направлениях вокруг себя.", "Передає сигнали в чотирьох напрямках навколо себе.", "Перадае сігналы ў чатырох напрамках вакол сябе.", "Transmet des signaux dans les quatre directions autour de soi-même.")],
                            [22, new i.I18nText("Sends a signal forwards.", "Передает сигнал вперед.", "Передає сигнал вперед.", "Перадае сігнал наперад.", "Transmet un ssignal en avant.")],
                            [23, new i.I18nText("Does nothing.", "Ничего не делает.", "Нічого не робить.", "Нічога не робіць.", "Ne fait rien")],
                            [24, new i.I18nText("Sends a signal forwards.", "Передает сигнал вперед.", "Передає сигнал вперед.", "Перадае сігнал наперад.", "Transmet un ssignal en avant.")]
                        ]);
            ...
            8448: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.LevelInfo = void 0, t.LevelInfo = class {
                    constructor(e, t) {
            ...
            4909: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.LevelOverlayInfo = void 0, t.LevelOverlayInfo = class {
                    constructor(e, t, s, i, n) {
                ...
                t.LevelsControls = class {
                    constructor(e, t) {
                        this.wheelCallback = e => {
                            this.wheelDelta += e
                        }, this.game = t, this.mouseHandler = new i.MouseHandler(e, (() => {}), (() => {}), this.wheelCallback), this.mousePosPrev = [0, 0], this.mousePressedPrev = !1, this.wheelDelta = 0
                    }
                    update() {
            ...
            5164: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.LevelsUI = void 0, t.LevelsUI = class {
                    dispose() {}
                }
            },
            9010: (e, t, s) => {
                ...
                t.Levels = h, i = h, h.levels = new Map, h.levelOverlayInfos = new Map, h.levelInitActions = new Map([
                    [0, e => {
                    ...
                    [1, e => {
                        const t = e => (null === e.state && 1 === e.arrow.signal && (e.state = 1), 2 === e.state && 1 === e.arrow.signal),
                            s = [
                                [0, new n.LevelArrow(22, 0, 0, t)],
                                [0, new n.LevelArrow(22, 0, -10, t)],
                                [1, new n.LevelArrow(22, 0, -20, t)],
                                [2, new n.LevelArrow(22, 10, -20, t)],
                                [3, new n.LevelArrow(22, 10, -10, t)],
                                [0, new n.LevelArrow(22, 2, -10, t)],
                                [0, new n.LevelArrow(22, 2, -18, (e => (null === e.state && 1 === e.arrow.signal && (e.state = 1), 1 === e.arrow.signal)))]
                            ],
                            o = [() => {
                                e.game.focusOnBox(0, -10, 0, 10, 3, .01), e.nextTutorialStep()
                            }, () => {
                                e.game.focusOnBox(0, -25, 0, -5, 3, .01), setTimeout((() => {
                                    e.game.focusOnBox(0, -10, 0, 10, 3, .02), e.playerControls.updatePlayerAccess({
                                        canMove: !0
                                    }), e.nextTutorialStep()
                                }), 2e3)
                            }, () => {
                                e.game.focusOnBox(0, -20, 10, -5, 3, .01), e.playerControls.updatePlayerAccess({
                                    canRotate: !0
                                }), e.nextTutorialStep()
                            }, () => {}, () => {}, () => {}, () => {}],
                            a = (t, i) => {
                    ...
                    [6, e => {
                        ...
                        e.levelArrows.push(new n.LevelArrow(22, 0, 10, (t => (t.arrow.signal = e.game.tick % 4 == 0 ? 1 : 0, !0)))), e.levelArrows.push(new n.LevelArrow(23, 0, 0, (i => {
                            ...
                            if (1 === i.state && 0 === i.arrow.signal) i.state = 2;
                            else {
                ...
                ]), h.levelRights = new Map([
                    [0, o.PlayerAccess.makeOnly({
                        canSetArrows: !0,
                        arrowGroups: [
                            [1]
                        ]
                ...
                ]), i.addLevel(0, [1], 15, 7, 5, [
                    [2, -1, 1]
                ]), i.addLevel(1, [2], 15, -1, 5, [
                    [2, -1, 1]
                ]), i.addLevel(2, [3], 15, -9, 5, [
                    [2, -1, 1]
                ]), i.addLevel(3, [4, 5], 15, -17, 5, [
                    [-1, 2, 1],
                    [5, 2, 1]
                ]), i.addLevel(4, [6], 0, -17, 5, [
                    [2, -1, 1]
                ]), i.addLevel(5, [8], 30, -17, 5, [
                    [2, -1, 1]
                ]), i.addLevel(6, [7], 2, -27, 5, [
                    [3, -1, 2]
                ]), i.addLevel(7, [10], 8, -36, 5, [
                    [4, -1, 2]
                ]), i.addLevel(8, [9], 28, -27, 5, [
                    [1, -1, 2]
                ]), i.addLevel(9, [10], 22, -36, 5, [
                    [0, -1, 2]
                ]), i.addLevel(10, [], 15, -45, 5, [
                    [2, -1, 2]
                ]), i.setPreviousLevels()
            },
            8804: (e, t, s) => {
                ...
                t.MenuPage = class {
                    constructor(e, t) {
                        this.categories = new Map([
                            ["account", [i.GameText.ACCOUNT.get(), "res/icons/icon-user.svg", null]],
                            ["levels", [i.GameText.LEVELS.get(), "res/icons/icon-levels.svg", null]],
                            ["maps", [i.GameText.MAPS.get(), "res/icons/icon-maps.svg", null]],
                            ["guide", [i.GameText.GUIDE.get(), "res/icons/icon-guide.svg", null]],
                            ["settings", [i.GameText.SETTINGS.get(), "res/icons/icon-settings.svg", null]],
                            ["back", [i.GameText.MENU_BACK.get(), "res/icons/menu-back-icon.svg", null]]
                        ]), this.action = t, this.page = null, this.mainDiv = document.createElement("div"), document.body.appendChild(this.mainDiv), this.mainDiv.id = "menu-page-main-div", this.sideBar = document.createElement("div"), this.mainDiv.appendChild(this.sideBar), this.sideBar.id = "menu-page-side-bar", this.content = document.createElement("div"), this.mainDiv.appendChild(this.content), this.content.id = "menu-page-content";
            ...
            1494: function(e, t, s) {
                ...
                class S {
                    ...
                    goToPath(e) {
                        if ("/login" === window.location.pathname) this.goToLogin(e);
                        else if ("/maps" === window.location.pathname) this.goToMaps(e);
                        ...
                        } else if ("/performance" === window.location.pathname) this.goToPerformance(e);
                        else if ("/levels" === window.location.pathname) this.goToLevels(e);
                        else if ("/account" === window.location.pathname) this.goToAccount(e);
                        else if ("/guide" === window.location.pathname) this.goToGuide(e);
                        else if ("/settings" === window.location.pathname) this.goToSettings(e);
                ...
                t.Game = class {
                    ...
                    updateFrame(e = (() => {})) {
                        if (this.playing && this.frame % l.PlayerSettings.framesToSkip[this.updateSpeedLevel] == 0)
                            for (let t = 0; t < l.PlayerSettings.framesToUpdate[this.updateSpeedLevel]; t++) this.updateTick(e), performance.now() - this.updateTime > 1e3 && (this.updateTime = performance.now(), this.updatesPerSecond = 0), this.updatesPerSecond++
                    }
                    updateTick(e = (() => {})) {
                ...
                class s {
                    constructor() {
                        this.arrowGroups = [
                            ...
                            [15, 16, 17, 18, 19],
                            [20, 21, 24]
                        ], this.canMove = !0, this.canZoom = !0, this.canPause = !0, this.canOpenMenu = !0, this.canChangeSpeed = !0, this.canSetArrows = !0, this.canDelete = !0, this.canRotate = !0, this.canFlip = !0, this.canSelect = !0, this.canCopy = !0, this.canPaste = !0, this.canPick = !0, this.canUndo = !0, this.canClearSignals = !0, this.canRunOneTick = !0
                    }
                    static makeCopy(e) {
                    ...
                    static makeOnly(e) {
                        ...
                        return t.arrowGroups = [
                            []
                        ], t.canMove = !1, t.canZoom = !1, t.canPause = !1, t.canOpenMenu = !1, t.canChangeSpeed = !1, t.canSetArrows = !1, t.canDelete = !1, t.canRotate = !1, t.canFlip = !1, t.canSelect = !1, t.canCopy = !1, t.canPaste = !1, t.canPick = !1, t.canUndo = !1, t.canClearSignals = !1, t.canRunOneTick = !1, Object.assign(Object.assign({}, t), e)
                    }
                }
                t.PlayerAccess = s
            },
                ...
                t.PlayerControls = class {
                    constructor(e, t, s, i = null) {
                        this.onPaste = () => {
                            ...
                            if ("KeyQ" === e) this.pickArrow();
                            else if ("Backquote" === e) this.takeCursor();
                            else if ("Space" === e) this.togglePause();
                            else if ("Enter" === e) this.runOneTick();
                            else if ("KeyZ" === e) null !== this.history && (s ? this.redo() : this.undo());
                            else if ("KeyY" === e) this.redo();
                            else if ("KeyX" === e) this.cutArrows();
                            else if ("KeyF" === e) {
                                if (this.freeCursor) {
                                    const e = this.getArrowByMousePosition();
                                    void 0 !== e && (this.flipDirection = !e.flipped, this.game.screenUpdated = !0)
                                }
                            } else if ("Backspace" === e) this.deleteSelectedArrows();
                            else if ("KeyC" === e) this.keyboardHandler.getCtrlPressed() || this.copyArrows();
                            else if ("KeyV" === e) this.keyboardHandler.getCtrlPressed() || this.pasteArrows();
                    ...
                    setArrows(e, t) {
                        this.playerAccess.canSetArrows && this.game.selectedMap.getCopiedArrows().forEach(((s, i) => {
                            ...
                            const [n, o] = i.split(",").map((e => parseInt(e, 10))), r = a.ArrowData.fromArrow(this.game.gameMap.getArrow(e + n, t + o)), l = a.ArrowData.fromState(s.type, s.rotation, s.flipped);
                    ...
                    deleteSelectedArrows() {
                        this.playerAccess.canDelete && (this.game.selectedMap.getSelectedArrows().forEach((e => {
                            const [t, s] = e.split(",").map((e => parseInt(e, 10))), i = a.ArrowData.fromArrow(this.game.gameMap.getArrow(t, s)), n = a.ArrowData.fromState(0, 0, !1);
            ...
            7779: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.PlayerMapAction = void 0, t.PlayerMapAction = class {
                    constructor() {
            ...
            403: (e, t, s) => {
                ...
                t.PlayerUI = class {
                    constructor(e) {
                        this.mapInfo = e, this.toolbarController = new l.UIToolbarController([
                            []
                        ]), this.pauseSign = new a.UIPauseSign(document.body), this.menu = null, this.speedController = null, this.controlsHint = null, this.autoSaveMessage = document.createElement("span"), this.autoSaveMessage.className = "ui-text-message", document.body.appendChild(this.autoSaveMessage)
                    }
                    updateToolbar(e) {
            ...
            2845: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.QUAD_INDICES = t.QUAD_POSITIONS = void 0, t.QUAD_POSITIONS = [0, 0, 1, 0, 1, 1, 0, 1], t.QUAD_INDICES = [0, 1, 2, 0, 2, 3]
            },
            3246: (e, t, s) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
            ...
            7377: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.Shader = void 0, t.Shader = class {
                    constructor() {
            ...
            9148: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.UIComponent = void 0, t.UIComponent = class {
                    constructor(e) {
            ...
            9984: (e, t, s) => {
                ...
                class o extends n.UIComponent {
                    constructor(e) {
                        super(e), this.dialog = document.createElement("dialog"), this.itemsBlock = document.createElement("div"), this.selectCallback = () => {}, this.arrowGroups = [], this.arrows = [], this.dialog.className = "ui-inventory", this.element.appendChild(this.dialog), this.dialog.appendChild(this.itemsBlock), this.dialog.onmousedown = e => e.stopPropagation(), this.dialog.onclick = () => this.dialog.close()
                    }
                    show() {
            ...
            1402: (e, t, s) => {
                ...
                class n extends i.UIComponent {
                    constructor(e, t) {
                        super(e);
                        const s = document.createElement("img");
                        s.src = "res/icons/level-play-button.svg", s.className = "level-play-button", s.onclick = () => {}, this.element.appendChild(s), this.element.addEventListener("click", t), this.element.onmousedown = e => e.stopPropagation()
                    }
                    getClass() {
            ...
            2203: (e, t, s) => {
                ...
                class n extends i.UIComponent {
                    constructor(e, t) {
                        ...
                        const s = document.createElement("img");
                        s.src = "res/icons/toolbar-arrow.svg", s.className = "toolbar-arrow-icon", s.onclick = () => {}, s.onmousedown = e => {
            ...
            9841: (e, t, s) => {
                ...
                class r extends i.UIComponent {
                    constructor(e, t, s) {
                        super(e), this.items = [], this.mouseCaptured = !1, this.itemsDiv = document.createElement("div"), this.itemsDiv.className = "ui-toolbar-items", this.arrowLeft = new n.UIToolbarArrow(this.element, "left"), this.element.appendChild(this.itemsDiv), this.arrowRight = new n.UIToolbarArrow(this.element, "right"), this.setArrows(t, s), this.selectCallback = () => {}, this.setItems(t, s), this.element.onpointerdown = e => {
                            this.mouseCaptured = !0
                    ...
                    isMouseCaptured() {
                        ...
                        for (let e = 0; e < this.items.length; e++)
                            if (this.items[e].isMouseCaptured()) return !0;
                        return !1
                    }
                    setSelectCallback(e) {
                        this.selectCallback = e
            ...
            2149: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.load = void 0, t.load = function(e, t) {
    ...
    function s(i) {
        ...
        r.PlayerSettings.arrowAtlasImage = p, p.src = `res/sprites/atlas.png?v=${r.PlayerSettings.version}`, p.addEventListener("load", (() => ((() => {
            for (let e = 0; e < navigator.languages.length; e++) {
                ...
                const s = t.indexOf("-"); - 1 !== s && (t = t.substring(0, s));
